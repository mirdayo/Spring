...
public class RestController_02Memo {
	...
	//메모쓰기
	@PostMapping("/add")	//http://localhost:8004/app/memo/add
	...
	@PutMapping("/put2")	//http://localhost:8004/app/memo/put2
	...
	//메모삭제
	@DeleteMapping("/remove/{id}")	//http://localhost:8004/app/memo/remove/{id}
