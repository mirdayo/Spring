...
public class ParamController {
	...
	@GetMapping("/param03")
	public void p3(@RequestParam(required = false, defaultValue = "테스트") String name) {
	...
	public void p7(Person person, Model model) {
		...
		//return "test/param07"; 경로가 매핑이랑 일치하면 그냥 void에 리턴 안줘도o jsp 파일 이름이 다르거나 하면
		//String으로 바꾸고 리턴 경로값 줘야함
	}
